...
$sql = "INSERT INTO service(fname,lname,phone,email)
...
<table>
<form name ="myform" action="service.php" method="post" onsubmit="return validateForm()">
<tr>
...
<td>
<input type=text name=firstname maxlength="15” pattern="[A-Za-z]+" title="Should not contain numbers">
</td>
</tr>
<tr>
...
<td>
<input type=text name=lastname maxlength="15” pattern="[A-Za-z]+"title="Should not contain numbers">
</td>
</tr>
<tr>
